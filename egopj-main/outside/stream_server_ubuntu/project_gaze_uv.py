...
def ensure_decoded_image_index(
    ...
    """Rebuild and validate decoded_index.csv for a visualization entrypoint."""
    ...
    decoder.validate_network_log_mapping(
        network_log_path,
...
def main() -> int:
    ...
    if not args.no_visualization:
        try:
            ...
            raise SystemExit(f"Frame alignment validation failed: {exc}") from exc
